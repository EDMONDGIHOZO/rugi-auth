...
app.listen(PORT, () => {
  console.log(\`🚀 Rugi Auth server running on http://localhost:\${PORT}\`);
...
async function initProject(projectName?: string) {
  ...
  try {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(PACKAGE_JSON_TEMPLATE(name), null, 2)
    );
    fs.writeFileSync(
    ...
    console.log();
    console.log(chalk.gray(`  Your server will be available at: ${chalk.cyan("http://localhost:7100")}`));
    console.log(chalk.gray(`  API documentation at: ${chalk.cyan("http://localhost:7100/docs")}`));
    console.log();
  } catch (error: any) {
...
async function initApp() {
  ...
  try {
    ...
    console.log(chalk.gray("  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"));
    console.log(chalk.yellow("  💾 Save these credentials - the secret won't be shown again!\n"));
  } catch (error: any) {
...
async function createSuperadmin() {
  ...
  try {
    ...
    console.log();
    console.log(chalk.bold("  👤 Superadmin Account\n"));
    console.log(chalk.gray("  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"));
    console.log(`  ${chalk.cyan("Email:")}  ${response.email}`);
    console.log(`  ${chalk.cyan("Roles:")}  superadmin, owner`);
    console.log(chalk.gray("  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"));
    console.log(chalk.green("  🎉 You can now log in to your Rugi Auth server!\n"));
  } catch (error: any) {
...
async function runSetup() {
  ...
  if (!fs.existsSync(privateKeyPath)) {
    ...
    console.log(chalk.gray("  ✓ RSA keys already exist\n"));
  }
