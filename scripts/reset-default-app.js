...
async function main() {
    ...
    if (!app) {
        ...
        const clientSecret = (0, uuid_1.v4)() + (0, uuid_1.v4)(); // 64-character secret
        const clientSecretHash = await (0, password_service_1.hashPassword)(clientSecret);
        app = await prisma.app.create({
            data: {
                name: DEFAULT_APP_NAME,
                clientId: DEFAULT_CLIENT_ID,
                clientSecretHash,
                type: client_1.AppType.CONFIDENTIAL,
                redirectUris: [
    ...
    const newClientSecret = (0, uuid_1.v4)() + (0, uuid_1.v4)(); // 64-character secret
    const newClientSecretHash = await (0, password_service_1.hashPassword)(newClientSecret);
    // Update the app
...
//# sourceMappingURL=reset-default-app.js.map